# Become a "jME3 Survival Game" Contributor

Let's build a game

## Communication
* Create a new thread under the [NULL](https://hub.jmonkeyengine.org/c/user-code-projects/null) in the [jMonkeyEngine Community](https://hub.jmonkeyengine.org).
